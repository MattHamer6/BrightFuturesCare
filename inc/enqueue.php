...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		// Fonts
		wp_enqueue_style( 'OpenSans', 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap' );
		...
		wp_enqueue_style( 'slick', get_template_directory_uri() . '/css/dist/slick.css', array(), $css_version );
		wp_enqueue_style( 'Fancybox', 'https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css' );
		
		wp_enqueue_style( 'updates', get_template_directory_uri() . '/css/updates.css', array(), $css_version );
		...
		// Dist
		wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/dist/slick.min.js', array(), $js_version, true );
