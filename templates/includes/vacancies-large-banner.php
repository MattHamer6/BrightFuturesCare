<?php 
  $img = get_field('large_banner_image', 'option');
  $text = get_field('large_banner_text', 'option');
  $align = get_field('large_banner_align', 'option');
  $btnText = get_field('large_banner_button_text', 'option');
  $btnLink = get_field('large_banner_button_link', 'option');
?>
